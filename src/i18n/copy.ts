  ...
  zh: {
    ...
    speakers: [
      ...
      },
      {
        ...
        photo: withBase("speakers/chew.jpg"),
        bio: "Soo Hong Chew 现任西南财经大学智慧经济科学研究中心主任、首席教授，以及新加坡国立大学经济学荣休教授。他是计量经济学会、经济理论促进学会与经济科学协会会士。研究聚焦决策理论、行为与实验经济学、生物经济学，以及风险与不确定性下的决策。研究成果发表于《计量经济学》《政治经济学杂志》《经济研究评论》《经济理论杂志》《管理科学》和《美国国家科学院院刊》等国际期刊。",
      },
      {
        badge: "邀请演讲",
        name: "孟涓涓",
